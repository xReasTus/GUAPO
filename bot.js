...
client.on('message', msg => {
  if (msg.content.toLowerCase() === '!!help') {
    msg.channel.send(':white_check_mark: **Destek Sunucum : https://discord.gg/eccRtSW9jX**')
    }
});
client.on('message', msg => {
...
client.on('message', msg => {
  ...
  if (msg.content.toLowerCase() === '!!invite') {
    ...
    .setDescription('Sunucumuz : https://discord.gg/eccRtSW9jX')
...
.setTitle('Destek Sunucumuz : https://discord.gg/eccRtSW9jX')
kanal.send(embed)
